...
|---|---|---|---|
| Review infrastructure risk and rollout order | sonnet | Cloud changes need judgment about blast radius, permissions, and dependency order. | ~700 |
...
| Extract deterministic helpers before calling AI for ug-ug. |
