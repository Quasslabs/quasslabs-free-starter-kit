...
| Extract deterministic helpers before calling AI for reflect. | Parsing, validation, routing, and manifests are cheaper and safer as pure functions. | FUNCTIONS.md classification |
