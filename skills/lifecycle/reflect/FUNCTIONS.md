...
| Item | Value | Notes |
|---|---|---|
| Bot/agents | any (developer · qa-auditor · deployer · scope-master · ballparker) | Terminal retrospective step. Run at the end of any project, milestone, or significant flow to capture what worked, what caused friction, and what was a near-miss. Writes lessons to LESSONS.md in the project root and surfaces memory promotions to memory-ladder. Callable by any bot as its final step. |
...
| Jira / Atlassian | https://[site].atlassian.net/rest/api/3 | API token or OAuth |
| Slack | https://slack.com/api | Slack bot/user token |
...
| Extract deterministic helpers before calling AI for reflect. |
