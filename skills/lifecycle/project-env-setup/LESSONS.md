# Lessons Learned — project-env-setup
...
| Extract deterministic helpers before calling AI for project-env-setup. | Parsing, validation, routing, and manifests are cheaper and safer as pure functions. | FUNCTIONS.md classification |
